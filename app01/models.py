...
class UserProfile(models.Model):
    ...
    follow_list = models.ManyToManyField('self',blank=True,related_name="my_fans",symmetrical=False,verbose_name='我的关注')
    #followers = models.ManyToManyField('self',related_name='my_followed_list',blank=True,verbose_name='我的粉丝')
...
class Category(models.Model):
    ...
    accounts = models.ManyToManyField(UserProfile)
    def __str__(self):
        return self.name